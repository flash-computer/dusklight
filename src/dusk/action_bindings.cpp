...
ActionBindsMap& getActionBinds() {
    static ActionBindsMap actionBinds = {
        ...
        {ActionBinds::TURBO_SPEED_BUTTON,   {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.turboSpeedButton, "Turbo Speed Button"}},
        {ActionBinds::DUSKLIGHT_SPECIAL, {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.dusklightSpecial,  "Special"}},
        ...
        {ActionBinds::QUICK_SPIN, {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.quickSpin,  "Quick Spin"}},
        ...
        {ActionBinds::INTERACT, {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.interact, "Interact/Confirm"}},
        {ActionBinds::REJECT, {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.reject, "Cancel"}},
        ...
        {ActionBinds::DIG,   {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.dig,   "Dig"}},
        {ActionBinds::SENSE,   {ActionBindContext::VERB,  ActionBindType::BUTTON,    &getSettings().actionBindings.sense,   "Sense"}},
